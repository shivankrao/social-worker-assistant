...
import {MainNav, ComponentsNav, LocationsNav, FormsNav, WidgetsNav, ChartsNav} from './NavItems';
    ...
    render() {
        return (
            <Fragment>
                ...
                <h5 className="app-sidebar__heading">Locations</h5>
                <MetisMenu content={LocationsNav} activeLinkFromLocation className="vertical-nav-menu" iconNamePrefix="" classNameStateIcon="pe-7s-angle-down"/>


                <h5 className="app-sidebar__heading">Files</h5>
